        ...
        <div className='hero-inner'>
          <div className='hero-content md:pl-[55px]'>
            ...
            <div className='button-container '>
              <button onClick={handleGetStartedClick} data-tip='Add Itinerary'>
                Get Started
              </button>
            </div>
          </div>
        ...
        <ul className='timeline timeline-vertical mt-6 sm:mt-8 lg:mt-10'>
          ...
          <li>
            ...
            <div className='timeline-end font-lato p-4 sm:p-5 text-custom-gray w-full sm:w-[400px] lg:w-[450px]'>
              ...
              Trip Planning page, where you’ll be guided through the next steps
          ...
          <li>
            ...
            <div className='timeline-end font-lato p-4 sm:p-5 text-custom-gray w-full sm:w-[400px] lg:w-[450px]'>
              Please provide your trip details by entering the destination, the
              length of your stay, and your budget. This information will help
              us tailor your itinerary to suit your preferences and ensure that
              your travel plans are well-organized and within your desired
              spending limits.
            </div>
            <hr className='bg-[#40A9EB] w-full sm:w-1/2 lg:w-1/3 mx-auto' />
          </li>
